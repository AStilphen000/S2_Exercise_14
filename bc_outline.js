...
*/
// generate outline based on h2 through h6 headings in the source document 
...
function createList(source, outlineList) {
      ...
      for (var n = source.firstChild; n !== null; n = n.nextSibling) {
            ...
            if (headLevel !== -1) {
                  // add an id to the heading if it is messing 
                  headNum++;
